...
from mask_generators import ImageMaskGenerator, ImageFaceMaskGenerator
...
def sampler(params):
    return normal_parse_params(params, 1e-3).mean


def optimizer(parameters):
    return Adam(parameters, lr=1e-3)
