...
from mask_generators import MCARGenerator, FaceTimeMaskGenerator
...
def get_imputation_networks(one_hot_max_sizes):
    ...
    return {
        ...
        'optimizer': lambda parameters: Adam(parameters, lr=1e-4),

        'mask_generator': FaceTimeMaskGenerator(0.2),
